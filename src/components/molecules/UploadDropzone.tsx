...
export function UploadDropzone({
  ...
  return (
    <div {...getRootProps()} className="cursor-pointer">
      <input {...getInputProps()} />
      <motion.div
        className="flex h-48 items-center justify-center rounded-2xl border-2 border-dashed border-white/40 bg-gradient-to-br from-white/5 to-white/10 text-white backdrop-blur-xl shadow-lg shadow-black/10"
